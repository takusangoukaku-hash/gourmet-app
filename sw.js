...
// =====================================================
const VERSION = 'v71'; // 登録の写真を小さいサムネイルにして店舗名の左へ（写真ありでも1画面に収める）
const CACHE = 'gourmet-' + VERSION;

// index.html の ?v= と揃える（古いキャッシュの混在防止）
const SHELL = [
  './', './index.html', './css/style.css?v=71',
  './js/store.js?v=71', './js/api.js?v=71', './js/cloud.js?v=71', './js/register.js?v=71', './js/views.js?v=71', './js/app.js?v=71',
