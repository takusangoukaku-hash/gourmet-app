...
// =====================================================
const VERSION = 'v13'; // 地図を日本語ラベル（地理院・縮小描画）に変更・ピン極小化
...
const CDN_HOSTS = ['unpkg.com', 'cdn.jsdelivr.net', 'esm.sh', 'tile.openstreetmap.org', 'basemaps.cartocdn.com', 'cyberjapandata.gsi.go.jp'];
