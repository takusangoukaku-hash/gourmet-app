...
// =====================================================
const VERSION = 'v64'; // 位置情報なし/AI案内メッセージと写真種別選択を削除、プロフィール写真の📷を＋に
const CACHE = 'gourmet-' + VERSION;

// index.html の ?v= と揃える（古いキャッシュの混在防止）
const SHELL = [
  './', './index.html', './css/style.css?v=64',
  './js/store.js?v=64', './js/api.js?v=64', './js/cloud.js?v=64', './js/register.js?v=64', './js/views.js?v=64', './js/app.js?v=64',
