...
// =====================================================
const VERSION = 'v292'; // 登録の味の評価: 星を大きく・なぞり入力・再タップで.5切替・数値表示（0.5刻みをスマホで確実に）
const CACHE = 'gourmet-' + VERSION;

// index.html の ?v= と揃える（古いキャッシュの混在防止）
const SHELL = [
  './', './index.html', './css/style.css?v=72',
  './js/store.js?v=72', './js/api.js?v=72', './js/cloud.js?v=72', './js/register.js?v=72', './js/views.js?v=72', './js/app.js?v=72',
