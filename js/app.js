...
const App = (() => {
  ...
  async function seedSample() {
    ...
    const samples = [
      {
        shop: { name: '麺屋 こがね', lat: 35.6595, lon: 139.7005, pref: '東京都', city: '渋谷区', station: '渋谷駅', shopGenre: 'ラーメン店', address: '東京都渋谷区道玄坂2丁目', favorite: true },
        visits: [
      ...
      {
        shop: { name: '寿司処 まる海', lat: 35.6654, lon: 139.7707, pref: '東京都', city: '中央区', station: '築地駅', shopGenre: '寿司店', address: '東京都中央区築地4丁目', favorite: true },
        visits: [
      ...
      {
        shop: { name: 'カフェ ひだまり', lat: 35.6684, lon: 139.7126, pref: '東京都', city: '港区', station: '表参道駅', shopGenre: 'カフェ', address: '東京都港区北青山3丁目', favorite: false },
        visits: [
