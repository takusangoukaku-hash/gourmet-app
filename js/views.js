...
const Views = (() => {
  ...
  // カテゴリータイルの配色: 4色まで（チャコール＋赤・オリーブ・ブルーの濃淡）
  // [0]はチャコール（「すべて」専用で他とかぶらない）。以降は3色を濃→薄→深で巡回
  const CAT_COLORS = [
    '#33302c',                       // チャコール（すべて）
    '#a63a2e', '#5f7355', '#4a6485', // 濃い赤・オリーブ・ブルー
    '#cf7f70', '#97a984', '#89a1bd', // 薄い赤・オリーブ・ブルー
    '#7f2d23', '#47593f', '#354962', // さらに濃い赤・オリーブ・ブルー
  ];
