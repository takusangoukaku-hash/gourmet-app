...
const Views = (() => {
  ...
  // カテゴリータイルの配色: 4色まで（アンバー＋コーラル・セージ・スカイブルーの濃淡）
  // [0]はアンバー（「すべて」専用で他とかぶらない）。以降は3色を濃→薄→中で巡回
  const CAT_COLORS = [
    '#d9a441',                       // アンバー（すべて）
    '#e2695a', '#7fb069', '#6d9bc3', // コーラル・セージ・スカイブルー
    '#f0a294', '#a9c99a', '#9dbfda', // 薄いコーラル・セージ・スカイブルー
    '#d04836', '#659a54', '#4f86b5', // 濃いめのコーラル・セージ・スカイブルー
  ];
